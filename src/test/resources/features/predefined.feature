...
#    Then "You have been Registered." confirmation message should be displayed
  ...
  @predefined3
   Scenario: Quiz Single Choice - Multiple Options
    Given I open "login" website
    When I type "ask_instr@aol.com" into email field
    When  I type "12345" into password field
    And I click "Sign In" button
    ...
    And I click "Create New Quiz" button
    And I wait for 1 sec
    When I type "000 Quiz Demo - Multiple options" as quiz title
    Then I add question
    When I select "Single" question type
    When I type "Question 1" into "Q1"
    And I type "Option 1" into "Q1" as "Option 1*"
    ...
    When I click "Save" button
    And I wait for 3 sec
    Then title "000 Quiz Demo - Multiple options" should be displayed on the list of quizzes
    And I delete quiz  "000 Quiz Demo - Multiple options"
