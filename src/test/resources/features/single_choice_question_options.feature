...
#    3. Create Single Choice Question with Max 15 + 1 choices
#    4. Create Single Choice Question with Other text area is included
#    5. Create Single Choice Question with Max 1000 +1 characters
  ...
  Scenario: Create Single Choice Question with valid information
    ...
    When I wait for 2 sec
    And I refresh the page
    Then "Test Quiz Single Choice13" is not displayed on the list of quizzes
  ...
  Scenario: Empty option fields
    ...
    When  I type "" into "Q1" input field "Option 2*"
    And I check "Option 2*" as correct in question "Q1"
    When I click "Save" button
  ...
  Scenario: Max 1000 characters
    ...
    And I check "Option 2*" as correct in question "Q1"
    When I click "Save" button
#    Then alert for maximum characters in Option field is displayed Bug#
    And I wait for 2 sec
    And I refresh the page
    Then "Test Quiz Single Choice13" is displayed on the list of quizzes
    When I wait for 2 sec
