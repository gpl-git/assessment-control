...
#      And I delete quiz "Demo Quiz - Automation" [MKs]
  ...
  Scenario: [SEP22-416] Option text field doesn't accept 1001 characters [MKs]
    ...
    And I wait for 1 sec [MKs]
    When I type "Question 1 text" into "Q1" [MKs]
#     I type 1001 characters into quiz option fields [MKs]
  ...
  Scenario: [SEP22-419] Option text field accepts 1 character [MKs]
    ...
    And I wait for 1 sec [MKs]
    When I type "Question 1 text" into "Q1" [MKs]
#     I type 1 characters into quiz option fields
    Then I type "1" into FirstOption [MKs]
    Then I type "1" into SecondOption [MKs]
    Then required quantity of characters "1" should be present in OptionField1 [MKs]
    Then I wait for 3 sec [MKs]
...
#     I type @ characters into quiz option fields
    Then I type "@" into FirstOption [MKs]
    Then I type "@" into SecondOption [MKs]
