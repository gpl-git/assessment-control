...
public class RegGroupCodeOlena {
    @When("I type {string} into {string} field")
    public void iTypeIntoField(String inputName, String fieldName) {
    ...
    public void iDeleteUser(String fullUserName) throws InterruptedException {
